...
```{r ggplot-with-aes-geom-cty, fig.alt="Scatter plot of  displacement vs city fuel efficiency with data points."}
ggplot(data = mpg, 
...
```{r aes_map_colour, fig.alt="Scatter plot of displacement vs city fuel efficiency with data points coloured by class."}
...
```{r aes_set_alpha, fig.alt="Scatter plot of displacement vs city fuel efficiency with data points coloured by class and made thirty percent visible."}
ggplot(data = mpg, mapping = aes(x = displ, y = cty,
                                 colour = class)) + 
...
```{r aes_set_map, fig.alt="Scatter plot of displacement vs city fuel efficiency with data points coloured by class and made thirty percent visible."}
ggplot(data = mpg, mapping = aes(x = displ, y = cty)) + 
...
```{r hwy-point, fig.alt="Scatter plot of displacement vs city fuel efficiency with data points coloured by class and made thirty percent visible. It includes a blue trendline with shaded confidence interval."}
ggplot(data = mpg, mapping = aes(x = displ, y = cty)) + 
  geom_point(aes(colour = class), alpha = 0.3) +
  geom_smooth()
```
...
```{r ch_order, fig.alt="Scatter plot of displacement vs city fuel efficiency with data points coloured by class and made thirty percent visible. It includes a blue trendline with error bars."}
ggplot(data = mpg, mapping = aes(x = displ, y = cty)) + 
  geom_smooth() +
  geom_point(aes(colour = class), alpha = 0.3)
