...
```{r cty-point, fig.alt="Scatter plot of displacement vs city fuel efficiency with data points coloured by class and made thirty percent visible. It includes a blue trendline with shaded confidence interval."}
ggplot(data = mpg, mapping = aes(x = displ, y = cty)) + 
  geom_point(aes(colour = class), alpha = 0.3) +
  geom_smooth()
```
