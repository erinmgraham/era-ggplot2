...
```{r bar-class, fig.alt="Bar plot of highway fuel efficiency for each class of vehicle."}
...
```{r bar-class-labs, fig.alt="Bar plot of highway fuel efficiency for each class of vehicle."}
ggplot(data = mpg, mapping = aes(x = class)) +
  geom_bar() +
  labs(
    x = "Vehicle class",
...
```{r bar-hwy-comp, fig.alt="Bar plot showing the number of mpg observations for each class of vehicle ."}
...
```{r bar-hwy-facet, fig.alt="Bar plot showing the number of mpg observations for each class of vehicle. Each drive type has its own panel."}
ggplot(data = mpg, mapping = aes(x = class)) +
  geom_bar() +
  facet_wrap(~ drv)
```
...
```{r bar-hwy-facet-lab, fig.alt="Bar plot showing the number of mpg observations for each class of vehicle. Each drive type has its own panel. Labels are rotated 45 degrees to improve readability."}
ggplot(data = mpg, mapping = aes(x = class)) +
  geom_bar() +
  facet_wrap(~ drv) +
...
```{r bar-hwy-facet-ch, fig.alt="Bar plot showing the number of mpg observations for each class of vehicle. Each drive type has its own panel."}
