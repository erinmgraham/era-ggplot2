...
```{r box-hwy, fig.alt="Boxplot of highway fuel efficiency."}
ggplot(data = mpg, 
       mapping = aes(x = hwy)) +
  geom_boxplot()
```
...
```{r box-hwy-class, fig.alt="Boxplot of highway fuel efficiency."}
ggplot(data = mpg, 
...
```{r box-hwy-class-colour, fig.alt="Boxplot of highway fuel efficiency."}
ggplot(data = mpg, 
