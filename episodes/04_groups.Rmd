...
```{r box-hwy, fig.alt="Box plot of highway fuel efficiency."}
ggplot(data = mpg, mapping = aes(x = hwy)) +
  geom_boxplot()
```
...
```{r box-hwy-class, fig.alt="Box plot of highway fuel efficiency."}
...
```{r box-hwy-class-colour, fig.alt="Box plot of highway fuel efficiency."}
