...
```{r bar-hwy, fig.alt="Bar plot showing the number of mpg observations for each class of vehicle ."}
ggplot(data = mpg, 
       mapping = aes(x = class)) +
  geom_bar()
```
...
```{r bar-hwy-drv, fig.alt="Bar plot showing the number of mpg observations for each class of vehicle ."}
ggplot(data = mpg, 
...
```{r bar-hwy-prop, fig.alt="Bar plot showing the proportion of mpg observations for each class of vehicle and drive type."}
ggplot(data = mpg, 
       mapping = aes(x = class, fill = drv)) +
